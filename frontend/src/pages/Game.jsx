...
function Game() {
    ...
    return (
        ...
        <div
            ...
            >
                {/* Ligne 1 : Mode + Départ + Cible (toujours visible) */}
                <div className="flex flex-wrap items-center gap-1.5 text-[10px] sm:text-[11px] uppercase tracking-wide text-slate-500">
                    <span className="rounded bg-slate-900 px-2 py-0.5 font-semibold text-white text-[10px] uppercase">{modeLabel}</span>
                    <span className="inline-flex min-w-0 max-w-[42vw] sm:max-w-56 lg:max-w-64 items-center gap-1 rounded border border-cyan-200 bg-cyan-50 px-2 py-0.5 text-cyan-800">
                    ...
                    <span className="inline-flex min-w-0 max-w-[42vw] sm:max-w-52 lg:max-w-60 items-center gap-1 rounded border border-fuchsia-200 bg-fuchsia-50 px-2 py-0.5 text-fuchsia-800">
                    ...
                    {adminCheatActive && game?.target_article && !won && (
                        <button
                            ...
                            className="inline-flex items-center gap-1 rounded border border-purple-400 bg-purple-600 px-2 py-0.5 text-[10px] font-bold text-white animate-pulse disabled:opacity-50"
                        >
                            <span>⚡ Triche</span>
                        </button>
                    )}
                ...
                {/* Ligne 2 : Article courant + Clics + Timer + Boutons */}
                <div className="mt-1.5 flex flex-wrap items-center gap-1.5 text-[10px] sm:text-[11px] uppercase tracking-wide text-slate-500">
                    <span className="inline-flex min-w-0 max-w-[40vw] sm:max-w-48 lg:max-w-56 items-center gap-1 rounded border border-blue-200 bg-blue-50 px-2 py-0.5 text-blue-800">
                    ...
                    <span className="rounded border border-amber-200 bg-amber-50 px-2 py-0.5 text-amber-800 whitespace-nowrap">
                        {t('game.clicks')}: <strong className="font-semibold text-amber-950">{clicks}</strong>
                    </span>
                    <span className="rounded border border-violet-200 bg-violet-50 px-2 py-0.5 text-violet-800 whitespace-nowrap">
                    ...
                    {isChronoMode && (
                        <span className="rounded border border-rose-200 bg-rose-50 px-2 py-0.5 text-rose-800 whitespace-nowrap">
                    ...
                    <button
                        ...
                        title={t('game.back')}
                        className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded border border-slate-200 bg-white text-slate-700 transition enabled:hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
                    >
                    ...
                    <button
                        ...
                        title={t('game.quit')}
                        className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded border border-rose-200 bg-rose-50 text-rose-700 transition hover:bg-rose-100 hover:text-rose-800"
                    >
                        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-3.5 w-3.5">
